...
## Use
Start [LiveSplit](https://livesplit.org/downloads/). 
Load or create your splits (11 segments for the 11 main bosses). 
Start [BizHawk](https://tasvideos.org/Bizhawk), load Shining Soul II (Japan) ROM.
Open "Lua Console" under "Tools".
Open the autosplitter script in the "Lua Console" window.
Output should show "SS2: autosplitter loaded".
Get your PB.
